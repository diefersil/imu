...
Donate link:
Tags: import, jetengine, crocoblock, meta box, xml, csv, metabox, wp all import
...
= Purchase =
Purchase the Pro Pack now at [our website](https://codingchicken.com/downloads/crocoblock-jetengine-importer-pro-pack/).
...
= 1.2.3 =
* bug fix: compatibility with latest WP All Import Pro version
...
= 1.1 =
* improvement: add support for [Pro Pack](https://codingchicken.com/downloads/crocoblock-jetengine-importer-pro-pack/)
