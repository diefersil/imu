...
if ( ! class_exists( 'Soflyy\WpAllImport\RapidAddon' ) ) {
	class RapidAddon {
        ...
        public $active_post_types, $active_themes, $active_plugins;
		public $name;
		public $slug;
		public $fields;
...
//		echo "</pre>";
		...
		*/
		...
		public function filter_post_types(
			$custom_types = array(), $custom_type = ''
		) {
		...
		public function sort_post_types(
			array $order
		) {
			$options    = $this->options_array();
		...
		public function move_post_type(
			$move_this = null, $move_to = null
		) {
			$move_rules = array();
