...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Xls;
...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Protection;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\SheetView;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     *
     * @return \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher $pValue
     */
    public function setEscher(?\GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher $pValue = null): void
    {
        $this->escher = $pValue;
    }
