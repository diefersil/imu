...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout $chartLayout Chart layout
     */
