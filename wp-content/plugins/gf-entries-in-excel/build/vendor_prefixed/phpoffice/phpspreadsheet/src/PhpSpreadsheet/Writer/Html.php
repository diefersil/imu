...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
    ...
    /**
     * Create CSS style (\GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Alignment).
     *
    ...
    /**
     * Create CSS style (\GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Font).
     *
     * @return array
     */
    ...
    private function generatePageDeclarations($generateSurroundingHTML)
    {
        ...
        foreach ($sheets as $worksheet) {
            ...
            if ($orientation === \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE) {
                $htmlPage .= 'size: landscape; ';
            } elseif ($orientation === \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT) {
