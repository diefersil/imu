...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Cell\Hyperlink;
...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\AutoFilter;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Chart;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\ConditionalStyles;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\DataValidations;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Hyperlinks;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\PageSetup;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SheetViewOptions;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SheetViews;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Styles;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\ReferenceHelper;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\RichText\RichText;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Settings;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Date;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Drawing;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\File;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Shared\StringHelper;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Spreadsheet;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Color;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if ($xmlDrawingChildren->oneCellAnchor) {
                                            foreach ($xmlDrawingChildren->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing = new \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objText->getFont()->setUnderline(\GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
    ...
    /**
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing $objDrawing
