...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Renderer\IRenderer;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Collection\Memory;
use GFExcel\Vendor\Psr\Http\Client\ClientInterface;
use GFExcel\Vendor\Psr\Http\Message\RequestFactoryInterface;
...
class Settings
{
     ...
     * eg: GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Chart\Renderer\JpGraph.
     *
     * @var string
     */
