...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBar;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\SheetView;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeCellFormula(XMLWriter $objWriter, string $cellValue, Cell $pCell): void
    {
        ...
        if (is_string($calculatedValue)) {
            if (\GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Functions::isError($calculatedValue)) {
