...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $pStyle, Spreadsheet $spreadsheet): void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $pStyle Style
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $pStyle): void
    {
        // dxf
     ...
     *
     * @return \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style */
