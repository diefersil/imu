...
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Row;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Writer\Exception;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Style;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row): void
    {
        ...
        while ($cells->valid()) {
            /** @var \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell */
            $cell = $cells->current();
