...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
     ...
     * @param \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $pDefaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \GFExcel\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
