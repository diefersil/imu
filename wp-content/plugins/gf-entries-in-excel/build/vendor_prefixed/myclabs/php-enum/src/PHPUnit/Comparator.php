...
namespace GFExcel\Vendor\MyCLabs\Enum\PHPUnit;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \GFExcel\Vendor\MyCLabs\Enum\PHPUnit\Comparator());
 */
