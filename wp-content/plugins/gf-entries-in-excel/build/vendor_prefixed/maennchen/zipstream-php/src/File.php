...
use GFExcel\Vendor\ZipStream\Exception\EncodingException;
use GFExcel\Vendor\ZipStream\Exception\FileNotFoundException;
use GFExcel\Vendor\ZipStream\Exception\FileNotReadableException;
use GFExcel\Vendor\ZipStream\Exception\OverflowException;
use GFExcel\Vendor\ZipStream\Option\File as FileOptions;
use GFExcel\Vendor\ZipStream\Option\Method;
use GFExcel\Vendor\ZipStream\Option\Version;
...
class File
{
     ...
     *
     * @return void
     * @throws \GFExcel\Vendor\ZipStream\Exception\EncodingException
     */
