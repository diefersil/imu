...
class GFExcel_VendorHTMLPurifier_HTMLModuleManager
{
    ...
    /**
     * @type GFExcel_VendorHTMLPurifier_DoctypeRegistry
     */
    public $doctypes;
    ...
    /**
     * @type GFExcel_VendorHTMLPurifier_AttrTypes
     */
    public $attrTypes;
     ...
     * @type GFExcel_VendorHTMLPurifier_HTMLModule[]
     */
    public $modules = array();

    /**
     * Array of recognized GFExcel_VendorHTMLPurifier_HTMLModule instances,
    ...
    /**
     * @type GFExcel_VendorHTMLPurifier_ContentSets
     */
    public $contentSets;

    /**
     * @type GFExcel_VendorHTMLPurifier_AttrCollections
     */
    ...
    public function __construct()
    {
        ...
        $this->attrTypes = new GFExcel_VendorHTMLPurifier_AttrTypes();
        $this->doctypes  = new GFExcel_VendorHTMLPurifier_DoctypeRegistry();
     ...
     *                GFExcel_VendorHTMLPurifier_HTMLModule prefix, or instance of
     *                subclass of GFExcel_VendorHTMLPurifier_HTMLModule.
    ...
    public function setup($config)
    {
        ...
        $this->contentSets = new GFExcel_VendorHTMLPurifier_ContentSets(
            // content set assembly deals with all possible modules,
            // not just ones deemed to be "safe"
            $this->modules
        );
        $this->attrCollections = new GFExcel_VendorHTMLPurifier_AttrCollections(
            $this->attrTypes,
     ...
     * @return Array of GFExcel_VendorHTMLPurifier_ElementDef
     */
     ...
     * @return GFExcel_VendorHTMLPurifier_ElementDef Merged GFExcel_VendorHTMLPurifier_ElementDef
