...
class GFExcel_VendorHTMLPurifier_HTMLModule_Legacy extends GFExcel_VendorHTMLPurifier_HTMLModule
{
    /**
     * @type string
     */
    ...
    public function setup($config)
    {
        ...
        $li->attr['value'] = new GFExcel_VendorHTMLPurifier_AttrDef_Integer();
        $li->attr['type'] = 'Enum#s:1,i,I,a,A,disc,square,circle';

        $ol = $this->addBlankElement('ol');
        $ol->attr['compact'] = 'Bool#compact';
        $ol->attr['start'] = new GFExcel_VendorHTMLPurifier_AttrDef_Integer();
