...
class GFExcel_VendorHTMLPurifier_Encoder
{
    ...
    {
        set_error_handler(array('GFExcel_VendorHTMLPurifier_Encoder', 'muteErrorHandler'));
        $r = iconv($in, $out, $text);
     ...
     * Arguably this function should be modernized to the GFExcel_VendorHTML5 set
    ...
    public static function convertToUTF8($str, $config, $context)
    {
        ...
        $bug = GFExcel_VendorHTMLPurifier_Encoder::testIconvTruncateBug();
