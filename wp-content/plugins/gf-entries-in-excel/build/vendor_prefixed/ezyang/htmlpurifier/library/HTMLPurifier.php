...
class GFExcel_VendorHTMLPurifier
{
     ...
     * @type GFExcel_VendorHTMLPurifier_Filter[]
     */
    ...
    /**
     * @type GFExcel_VendorHTMLPurifier_Strategy_Core
     */
    protected $strategy;
     ...
     *
     * @param GFExcel_VendorHTMLPurifier_Filter $filter GFExcel_VendorHTMLPurifier_Filter object
     */
    ...
    public function purify($html, $config = null)
    {
        ...
        $lexer = GFExcel_VendorHTMLPurifier_Lexer::create($config);

        $context = new GFExcel_VendorHTMLPurifier_Context();

        // setup HTML generator
        $this->generator = new GFExcel_VendorHTMLPurifier_Generator($config, $context);
        $context->register('Generator', $this->generator);

        // set up global context variables
        if ($config->get('Core.CollectErrors')) {
            // may get moved out if other facilities use it
            $language_factory = GFExcel_VendorHTMLPurifier_LanguageFactory::instance();
            $language = $language_factory->create($config, $context);
            $context->register('Locale', $language);

            $error_collector = new GFExcel_VendorHTMLPurifier_ErrorCollector($context);
            $context->register('ErrorCollector', $error_collector);
        }

        // setup id_accumulator context, necessary due to the fact that
        // AttrValidator can be called from many places
        $id_accumulator = GFExcel_VendorHTMLPurifier_IDAccumulator::build($config, $context);
        $context->register('IDAccumulator', $id_accumulator);

        $html = GFExcel_VendorHTMLPurifier_Encoder::convertToUTF8($html, $config, $context);
        ...
        $html = GFExcel_VendorHTMLPurifier_Encoder::convertFromUTF8($html, $config, $context);
