...
class GFExcel_VendorHTMLPurifier_HTMLModule_Forms extends GFExcel_VendorHTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        $input->attr_transform_post[] = new GFExcel_VendorHTMLPurifier_AttrTransform_Input();
        ...
        $textarea->attr_transform_pre[] = new GFExcel_VendorHTMLPurifier_AttrTransform_Textarea();
