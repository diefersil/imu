...
class GFExcel_VendorHTMLPurifier_Printer_HTMLDefinition extends GFExcel_VendorHTMLPurifier_Printer
{

    /**
     * @type GFExcel_VendorHTMLPurifier_HTMLDefinition, for easy access
     */
    protected $def;
    ...
    public function render($config)
    {
        ...
        $ret .= $this->start('div', array('class' => 'GFExcel_VendorHTMLPurifier_Printer'));
     ...
     * @param GFExcel_VendorHTMLPurifier_ChildDef $def GFExcel_VendorHTMLPurifier_ChildDef of pertinent element
     * @return string
     */
     ...
     * @param array $array Array hash in form of array('attrname' => GFExcel_VendorHTMLPurifier_AttrDef)
     * @return string
     */
