 ...
 * are best described GFExcel_VendorHTMLPurifier_Strategy_MakeWellFormed->processToken()
 * documentation.
 *
...
abstract class GFExcel_VendorHTMLPurifier_Injector
{
     ...
     * @param GFExcel_VendorHTMLPurifier_Token $current Current token variable.
    ...
    protected function forwardUntilEndToken(&$i, &$current, &$nesting)
    {
        ...
        if ($current instanceof GFExcel_VendorHTMLPurifier_Token_Start) {
            $nesting++;
        } elseif ($current instanceof GFExcel_VendorHTMLPurifier_Token_End) {
            if ($nesting <= 0) {
                return false;
            }
            $nesting--;
     ...
     * @param GFExcel_VendorHTMLPurifier_Token $token Current token variable.
