...
class GFExcel_VendorHTMLPurifier_Printer_ConfigForm extends GFExcel_VendorHTMLPurifier_Printer
{
     ...
     * @type GFExcel_VendorHTMLPurifier_Printer[]
     */
...
class GFExcel_VendorHTMLPurifier_Printer_ConfigForm_NullDecorator extends GFExcel_VendorHTMLPurifier_Printer
{
    ...
    /**
     * @param GFExcel_VendorHTMLPurifier_Printer $obj Printer to decorate
     */
...
class GFExcel_VendorHTMLPurifier_Printer_ConfigForm_default extends GFExcel_VendorHTMLPurifier_Printer
{
    ...
    public function render($ns, $directive, $value, $name, $config)
    {
        ...
        if (is_array($value)) {
            switch ($type) {
                case GFExcel_VendorHTMLPurifier_VarParser::LOOKUP:
                    $array = $value;
                    $value = array();
                ...
                case GFExcel_VendorHTMLPurifier_VarParser::ALIST:
                    $value = implode(PHP_EOL, $value);
                    break;
                case GFExcel_VendorHTMLPurifier_VarParser::HASH:
                    $nvalue = '';
        ...
        if ($type === GFExcel_VendorHTMLPurifier_VarParser::C_MIXED) {
        ...
        if (isset($def->allowed)) {
            ...
            $ret .= $this->end('select');
        } elseif ($type === GFExcel_VendorHTMLPurifier_VarParser::TEXT ||
                $type === GFExcel_VendorHTMLPurifier_VarParser::ITEXT ||
                $type === GFExcel_VendorHTMLPurifier_VarParser::ALIST ||
                $type === GFExcel_VendorHTMLPurifier_VarParser::HASH ||
                $type === GFExcel_VendorHTMLPurifier_VarParser::LOOKUP) {
            $attr['cols'] = $this->cols;
            $attr['rows'] = $this->rows;
