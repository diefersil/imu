...
class GFExcel_VendorHTMLPurifier_Strategy_FixNesting extends GFExcel_VendorHTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // refer to substrings
        $top_node = GFExcel_VendorHTMLPurifier_Arborize::arborize($tokens, $config, $context);
        ...
        while (!empty($stack)) {
            ...
            while (isset($node->children[$ix])) {
                ...
                if ($child instanceof GFExcel_VendorHTMLPurifier_Node_Element) {
                    $go = true;
        ...
        return GFExcel_VendorHTMLPurifier_Arborize::flatten($node, $config, $context);
    }
}
