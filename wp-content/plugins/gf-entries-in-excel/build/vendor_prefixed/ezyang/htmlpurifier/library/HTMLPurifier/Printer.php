...
class GFExcel_VendorHTMLPurifier_Printer
{
    ...
    protected function start($tag, $attr = array())
    {
        return $this->generator->generateFromToken(
            new GFExcel_VendorHTMLPurifier_Token_Start($tag, $attr ? $attr : array())
        );
    }
    ...
    {
        return $this->generator->generateFromToken(
            new GFExcel_VendorHTMLPurifier_Token_End($tag)
        );
    }
    ...
    {
        return $this->generator->generateFromToken(
            new GFExcel_VendorHTMLPurifier_Token_Empty($tag, $attr)
        );
    }
    ...
    {
        return $this->generator->generateFromToken(
            new GFExcel_VendorHTMLPurifier_Token_Text($text)
        );
    }
    ...
    {
        $string = GFExcel_VendorHTMLPurifier_Encoder::cleanUTF8($string);
