 ...
 */
class GFExcel_VendorHTMLPurifier_ErrorStruct
{
     ...
     * values for this:
     *  - TOKEN: Instance of GFExcel_VendorHTMLPurifier_Token
    ...
    public function getChild($type, $id)
    {
        if (!isset($this->children[$type][$id])) {
            $this->children[$type][$id] = new GFExcel_VendorHTMLPurifier_ErrorStruct();
