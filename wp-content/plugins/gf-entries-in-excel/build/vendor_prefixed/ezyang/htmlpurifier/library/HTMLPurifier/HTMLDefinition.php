...
class GFExcel_VendorHTMLPurifier_HTMLDefinition extends GFExcel_VendorHTMLPurifier_Definition
{
    ...
    /**
     * Associative array of element names to GFExcel_VendorHTMLPurifier_ElementDef.
     * @type GFExcel_VendorHTMLPurifier_ElementDef[]
     */
    public $info = array();
    ...
    /**
     * Indexed list of GFExcel_VendorHTMLPurifier_AttrTransform to be performed before validation.
     * @type GFExcel_VendorHTMLPurifier_AttrTransform[]
     */
    public $info_attr_transform_pre = array();

    /**
     * Indexed list of GFExcel_VendorHTMLPurifier_AttrTransform to be performed after validation.
     * @type GFExcel_VendorHTMLPurifier_AttrTransform[]
     */
    ...
    /**
     * Indexed list of GFExcel_VendorHTMLPurifier_Injector to be used.
    ...
    /**
     * Doctype object
     * @type GFExcel_VendorHTMLPurifier_Doctype
     */
    public $doctype;
     ...
     *       method in GFExcel_VendorHTMLPurifier_HTMLModule
     ...
     *             GFExcel_VendorHTMLPurifier_AttrTypes for details
     */
     ...
     * @see GFExcel_VendorHTMLPurifier_HTMLModule::addElement() for detailed
     ...
     * @return GFExcel_VendorHTMLPurifier_ElementDef
     * @see GFExcel_VendorHTMLPurifier_HTMLModule::addBlankElement() for detailed
     *       parameter and return value descriptions.
     */
     ...
     * module.
     * @return GFExcel_VendorHTMLPurifier_HTMLModule
     */
    public function getAnonymousModule()
    {
        if (!$this->_anonModule) {
            $this->_anonModule = new GFExcel_VendorHTMLPurifier_HTMLModule();
    ...
    /**
     * @type GFExcel_VendorHTMLPurifier_HTMLModuleManager
     */
    public $manager;
    ...
    {
        $this->manager = new GFExcel_VendorHTMLPurifier_HTMLModuleManager();
    }
