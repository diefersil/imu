 ...
 */
class GFExcel_VendorHTMLPurifier_VarParser_Flexible extends GFExcel_VendorHTMLPurifier_VarParser
{
    /**
     * @param mixed $var
     * @param int $type
            ...
            case self::C_BOOL:
                if (is_int($var) && ($var === 0 || $var === 1)) {
                    ...
                    if ($var == 'on' || $var == 'true' || $var == '1') {
                        ...
                        throw new GFExcel_VendorHTMLPurifier_VarParserException("Unrecognized value '$var' for $type");
                    }
                }
                return $var;
            case self::ALIST:
