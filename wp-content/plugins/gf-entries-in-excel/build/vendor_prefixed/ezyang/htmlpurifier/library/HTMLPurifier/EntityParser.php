...
class GFExcel_VendorHTMLPurifier_EntityParser
{
     ...
     * @type GFExcel_VendorHTMLPurifier_EntityLookup
     */
    ...
    protected function entityCallback($matches)
    {
        ...
        if ($hex_part !== NULL && $hex_part !== "") {
            ...
            return GFExcel_VendorHTMLPurifier_Encoder::unichr((int) $dec_part);
        } else {
            if (!$this->_entity_lookup) {
                $this->_entity_lookup = GFExcel_VendorHTMLPurifier_EntityLookup::instance();
            }
    ...
    protected function nonSpecialEntityCallback($matches)
    {
        ...
        if ($is_num) {
            ...
            return GFExcel_VendorHTMLPurifier_Encoder::unichr($code);
        } else {
