...
class GFExcel_VendorHTMLPurifier_Filter_ExtractStyleBlocks extends GFExcel_VendorHTMLPurifier_Filter
{
    ...
    /**
     * @type GFExcel_VendorHTMLPurifier_AttrDef_CSS_Ident
     */
    ...
    public function __construct()
    {
        ...
        $this->_id_attrdef = new GFExcel_VendorHTMLPurifier_AttrDef_HTML_ID(true);
        $this->_class_attrdef = new GFExcel_VendorHTMLPurifier_AttrDef_CSS_Ident();
        $this->_enum_attrdef = new GFExcel_VendorHTMLPurifier_AttrDef_Enum(
            array(
                'first-child',
                'link',
                'visited',
                                ...
                                for ($j = 0, $cc = count($components); $j < $cc; $j++) {
                                    ...
                                    if ($j === 0) {
                                        ...
                                        if ($sdelim === '#') {
                                            ...
                                            throw new GFExcel_VendorHTMLPurifier_Exception('broken invariant sdelim and preg_split');
                                        }
