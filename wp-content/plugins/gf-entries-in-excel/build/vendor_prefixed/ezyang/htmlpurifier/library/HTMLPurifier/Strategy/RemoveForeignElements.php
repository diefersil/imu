...
class GFExcel_VendorHTMLPurifier_Strategy_RemoveForeignElements extends GFExcel_VendorHTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        $attr_validator = new GFExcel_VendorHTMLPurifier_AttrValidator();
        ...
        foreach ($tokens as $token) {
            ...
            if (!empty($token->is_tag)) {
                ...
                if (isset($definition->info[$token->name])) {
                    ...
                    if (isset($hidden_elements[$token->name]) && $token instanceof GFExcel_VendorHTMLPurifier_Token_Start) {
                        $textify_comments = $token->name;
                    } elseif ($token->name === $textify_comments && $token instanceof GFExcel_VendorHTMLPurifier_Token_End) {
                        $textify_comments = false;
                    }
                ...
                if ($textify_comments !== false) {
                    $data = $token->data;
                    $token = new GFExcel_VendorHTMLPurifier_Token_Text($data);
