...
class GFExcel_VendorHTMLPurifier_DoctypeRegistry
{
     ...
     * @return GFExcel_VendorHTMLPurifier_Doctype Editable registered doctype
     */
    public function register(
        ...
        if (!is_object($doctype)) {
            $doctype = new GFExcel_VendorHTMLPurifier_Doctype(
                $doctype,
                $xml,
                $modules,
                $tidy_modules,
     ...
     * @return GFExcel_VendorHTMLPurifier_Doctype Editable doctype object
     */
