...
class GFExcel_VendorHTMLPurifier_Config
{
     ...
     * @type GFExcel_VendorHTMLPurifier_VarParser_Flexible
     */
     ...
     * @type GFExcel_VendorHTMLPurifier_Definition[]
     */
    ...
    public function __construct($definition, $parent = null)
    {
        ...
        $this->plist = new GFExcel_VendorHTMLPurifier_PropertyList($parent);
        $this->def = $definition; // keep a copy around for checking
        $this->parser = new GFExcel_VendorHTMLPurifier_VarParser_Flexible();
    }
    ...
    public function set($key, $value, $a = null)
    {
        ...
        try {
            ...
            $this->triggerError(
                ...
                GFExcel_VendorHTMLPurifier_VarParser::getTypeName($type),
                E_USER_WARNING
            );
            return;
        }
     ...
     *             named, instead.
     *
     * @return GFExcel_VendorHTMLPurifier_HTMLDefinition|null
     */
     ...
     *             named, instead.
     *
     * @return GFExcel_VendorHTMLPurifier_CSSDefinition|null
     */
     ...
     *             named, instead.
     *
     * @return GFExcel_VendorHTMLPurifier_URIDefinition|null
     */
     ...
     * @return GFExcel_VendorHTMLPurifier_Definition|null
     */
    public function getDefinition($type, $raw = false, $optimized = false)
    {
        if ($optimized && !$raw) {
            throw new GFExcel_VendorHTMLPurifier_Exception("Cannot set optimized = true when raw = false");
        }
        if (!$this->finalized) {
            $this->autoFinalize();
        }
        ...
        $lock = $this->lock;
        $this->lock = null;
        $factory = GFExcel_VendorHTMLPurifier_DefinitionCacheFactory::instance();
        ...
        throw new GFExcel_VendorHTMLPurifier_Exception("The impossible happened!");
    }
     ...
     *
     * @return GFExcel_VendorHTMLPurifier_CSSDefinition|GFExcel_VendorHTMLPurifier_HTMLDefinition|GFExcel_VendorHTMLPurifier_URIDefinition
     * @throws GFExcel_VendorHTMLPurifier_Exception
     */
    private function initDefinition($type)
    {
        ...
        if ($type == 'HTML') {
            $def = new GFExcel_VendorHTMLPurifier_HTMLDefinition();
        } elseif ($type == 'CSS') {
            $def = new GFExcel_VendorHTMLPurifier_CSSDefinition();
        } elseif ($type == 'URI') {
            $def = new GFExcel_VendorHTMLPurifier_URIDefinition();
        } else {
            throw new GFExcel_VendorHTMLPurifier_Exception(
