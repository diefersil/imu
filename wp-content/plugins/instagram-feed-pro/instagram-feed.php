...
update_option('sbi_license_key', '************');
update_option('sbi_license_status', 'valid');

$license_data = array(
	'license'    => 'valid',  // Set the license status to 'valid'
	'expires'    => '2050-01-01',  // Set the license expiration date
	'site_count' => 1,  // Set the number of sites used
	'max_sites'  => 99,  // Set the maximum number of sites allowed
);
